...
wg-eval 0.1.0 (git 3d729e2+dirty)
...
|------------------------------------|--------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|------------|----------|
| `observation_bootstrap`            | resample observations instead of whole units           | intervals narrower than the design earns, by up to sqrt(sub-units per unit) when units differ in how they respond to the policies | 4, 27      | yes      |
...
| `p_value_read_as_equivalence`      | relabel an inconclusive result as equivalent           | an unresolved contrast presented as a finding of sameness                                                                         | 12, 30     | yes      |
